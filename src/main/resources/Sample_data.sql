...
('Floor Cleaner', 'Cleaning Chemicals', 35, 8, 'Bottle', 2),
('Microfiber Cloth', 'Cleaning Equipment', 100, 20, 'Pack', 1),
('Rubber Gloves', 'Safety Equipment', 75, 15, 'Box', 3),
('Toilet Paper', 'Paper Products', 200, 50, 'Roll', 2),
('Hand Soap', 'Cleaning Chemicals', 60, 15, 'Bottle', 1),
('Bin Bags', 'Waste Management', 150, 30, 'Pack', 3),
('Mop Heads', 'Cleaning Equipment', 25, 5, 'Piece', 2),
('Air Freshener', 'Hygiene Products', 40, 10, 'Can', 1),
('Bleach', 'Cleaning Chemicals', 30, 10, 'Bottle', 3);
